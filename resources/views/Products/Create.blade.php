...
@section('container')
    ...
    <div class="container mt-5 mb-5">
        <div class="row">
           ...
           <div class="form-floating">
            <input type="text" class="form-control @error('price') is-invalid @enderror" id="" name="price" value="0" >
           ...
           <div class="form-floating">
               <input type="text" class="form-control @error('stock') is-invalid @enderror" id="" name="stock" value="0" >
