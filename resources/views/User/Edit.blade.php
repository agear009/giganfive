...
@section('container')
    ...
    <div class="container mt-5 mb-5">
        <div class="row">
           ...
           <div class="form-floating">
            <input type="text" class="form-control @error('name') is-invalid @enderror" id="floatingInput" placeholder="1122@gG" name="email" value="{{ $user->email }}" required>
           ...
           <div class="form-floating">
            <input type="password" class="form-control @error('password') is-invalid @enderror" id="floatingInput" placeholder="1122@gG" name="password" value="{{ $user->password }}" required>
